...
test.describe('MessageBubble Component', () => {
  test.describe('Message Rendering', () => {
    test('TC-MSG-001: renders user messages right-aligned', async ({ page, request }) => {
    ...
    test('TC-MSG-002: renders assistant messages left-aligned', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'u1',
    ...
    test('TC-MSG-003: identifies user message by data-testid role', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'u1',
    ...
    test('TC-MSG-004: displays message timestamp', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'u1',
    ...
    test('TC-MSG-005: renders markdown content correctly', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MSG-006: renders inline code with distinct background', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MSG-007: renders links with correct styling', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
  ...
  test.describe('Visual Styling', () => {
    ...
    test('TC-MSG-014: message background colors use design tokens', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'u1',
  ...
  test.describe('Code Block Rendering', () => {
    ...
    test('TC-CODE-002: code block has language label', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-CODE-003: copy button is visible on code blocks', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-CODE-004: copy button copies content to clipboard', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
  ...
  test.describe('Markdown Features', () => {
    test('TC-MD-001: table renders with correct HTML structure', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MD-002: blockquote renders with correct styling', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MD-003: inline code has distinct background', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MD-004: list items render correctly', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MD-005: ordered list renders correctly', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MD-006: headings render with correct hierarchy', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
    ...
    test('TC-MD-007: horizontal rule renders as styled element', async ({ page, request }) => {
      await setupChatPage(page, request);
      await seedMessages(page, [
        {
          id: 'a1',
