...
describe('GitRepoManager', () => {
  ...
  it('connects repositories to the active collection without a collection field', async () => {
    ...
    expect(document.body.querySelector('[data-testid="git-repo-collection-select"]')).toBeNull();
    ...
    document.body.querySelector<HTMLElement>('[data-testid="btn-git-repo-register"]')?.click();
