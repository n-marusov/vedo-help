...
export const api = {
	...
	createGitRepo: (req: CreateRepoRequest) =>
		api.post<GitRepoSummary>("/git-sync/repos", req),
	triggerSync: (id: string) =>
		api.post<SyncStatusResponse>(`/git-sync/repos/${id}/sync`),
	deleteGitRepo: (id: string) =>
