...
- **Commit 3** (after Tasks 4-5): "test: E2E tests for markdown code rendering and syntax highlighting"
- **Commit 4** (after Task 6-7): "feat: add RAG flow E2E tests, CI workflow, and Markdown doc"

## Tasks

### Phase 1: Markdown Engine & Syntax Highlighting

- [x] **Task 1: Upgrade marked configuration and integrate highlight.js**
...
- [x] **Task 2: Add language label to code blocks**
...
- [x] **Task 3: Add copy-to-clipboard button on code blocks**
...
- [x] **Task 4: Enhance markdown rendering and styling with design tokens**
...
- [x] **Task 5: Add E2E tests for syntax highlighting, copy button, and markdown features**
...
### Phase 5: RAG Flow E2E Tests (upload → query → sources)

- [x] **Task 6: Add E2E tests for full RAG flow (upload → query → sources)**

  **Deliverable:** Playwright E2E-тесты для полного цикла: загрузка документа через админ-панель, отправка запроса в чат, проверка стриминга и источников.

  **Changes:**
  - `frontend/e2e/rag-flow.spec.ts` — новый файл с тестами:
    - `TC-RAG-001`: admin upload page renders correctly
    - `TC-RAG-002`: upload document via admin panel (mocked)
    - `TC-RAG-003`: send query and verify streaming response
    - `TC-RAG-004`: sources appear in query response
    - `TC-RAG-005`: new chat clears messages
  - Настроить CI для Playwright (`github/workflows/e2e.yml`)

  **Files:**
  - `frontend/e2e/rag-flow.spec.ts` (новый)
  - `.github/workflows/e2e.yml` (новый)

  **Dependencies:** Tasks 1-5

### Phase 6: Documentation & Cleanup

- [x] **Task 7: Update documentation and CHECKLIST.md**
